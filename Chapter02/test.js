...
//here var asian = new Asian(), and want to access asian.shareV, but no then check with asian.__proto__ which is Aisan.prototype, still no, check Asian.prototype.__proto__ which is Person.prototype
